...
- [Getting started](getting-started.md): install the toolkit, activate it, run lint and tests
- [Architecture](architecture.md): prefix layout, CLI vs wrappers, request flow
